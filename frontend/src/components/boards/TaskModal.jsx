...
import { 
  ...
  MessageSquare, Clock, Flag, Eye, MoreHorizontal,
  Plus, Trash2, Check, Edit2, ChevronRight, AlertCircle,
  Play, Square, ChevronLeft, Upload, Image, Loader2, Pin
} from 'lucide-react';
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-72 bg-gray-50 p-6 space-y-4 border-t lg:border-t-0 lg:border-l border-gray-200">
            ...
            {/* Due Date con Calendario - Ahora en segundo lugar después de Anclar */}
